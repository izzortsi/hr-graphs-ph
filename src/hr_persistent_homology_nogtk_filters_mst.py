...
ibin = 0.0005
fbin = 0.3
step = 0.1  # move step 0.1 tava legal
K = 0.3
...
##
mst = gt.min_spanning_tree(ug)
##
ug.set_edge_filter(mst)
##
ug = gt.Graph(g=ug, prune=True)
##
ug.num_edges()
##
